...
public class CombatStatManager {
	 ...
	 */
	public CombatStatManager(int hp, int attack, int defense,
	 ...
	 * 
	 * @param value
	 *            - The new Special Attack stat value
	 */
	 ...
	 * 
	 * @param value
	 *            - The new Special Defense stat value
	 */
